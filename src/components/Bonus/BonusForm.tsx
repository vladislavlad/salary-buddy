...
export function BonusForm({
  ...
  initial?: { id: string; date: Date; amount: number; type: BonusType };
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between mb-1">
        <span className="text-xs text-muted-foreground">{isEdit ? 'Редактировать премию' : 'Новая премия'}</span>
      ...
      <div className="space-y-2">
        ...
        {type === 'salaries' ? (
          <NumberField label="Кол-во окладов" value={amount} min={0} onChange={setAmount} />
        ) : (
          <div className="space-y-2">
