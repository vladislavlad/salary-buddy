      ...
      <div className="flex h-8 rounded-md border border-input shadow-sm">
        ...
        <div className="flex flex-col border-l">
          <button
            ...
            className="flex-1 flex items-center justify-center w-7 text-muted-foreground hover:text-foreground transition-colors disabled:opacity-30 disabled:pointer-events-none"
          >
